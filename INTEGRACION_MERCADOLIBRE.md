...
Integración OAuth2 completa con MercadoLibre para tu Apice multi-tenant. Permite a cada usuario del Apice conectar su propia cuenta de MercadoLibre y recibir automáticamente:

- 💬 **Mensajes** de compradores
- ❓ **Preguntas** sobre productos
- 🛒 **Órdenes** de compra

Todos los eventos se convierten automáticamente en **Leads** en el Apice.
...
Almacena las credenciales OAuth por usuario del Apice.

**Campos:**
- `user` - Usuario del Apice (OneToOne)
...
if processed_data['type'] == 'message':
    ...
    from apice.models import Contact, Deal
...
**Tu Apice ahora puede capturar leads desde MercadoLibre automáticamente.** 🚀
