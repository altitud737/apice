...
def dashboard(request):
    ...
    return render(request, 'apice/dashboard.html', context)
...
def contacts_list(request):
    ...
    return render(request, 'apice/contacts.html', context)
...
def pipeline(request):
    ...
    if pipeline_id:
        from apice.models import Pipeline
    ...
    return render(request, 'apice/pipeline.html', context)
...
def create_deal(request):
    if request.method == 'POST':
        ...
        if not stage:
            ...
            return redirect('apice:pipeline')
...
def create_contact(request):
    if request.method == 'POST':
        ...
        return redirect('apice:contacts')
...
def manage_pipelines(request):
    ...
    return render(request, 'apice/manage_pipelines.html', context)
...
def create_pipeline(request):
    if request.method == 'POST':
        ...
        return redirect('apice:manage_pipelines')
...
def manage_templates(request):
    ...
    return render(request, 'apice/manage_templates.html', context)
...
def create_template(request):
    if request.method == 'POST':
        ...
        return redirect('apice:manage_templates')
