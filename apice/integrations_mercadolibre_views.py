...
def mercadolibre_connect(request):
    ...
    if not company:
        ...
        return redirect('apice:integrations')
...
def mercadolibre_status(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_status.html', context)
...
def autoreply_templates_list(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_autoreply_list.html', context)
...
def autoreply_template_create(request):
    ...
    if request.method == 'POST':
        ...
        if not name or not response_text:
            ...
            return render(request, 'apice/integrations/mercadolibre_autoreply_form.html', {
        ...
        return redirect('apice:mercadolibre:autoreply_list')
...
def products_list(request):
    ...
    if not integration:
        ...
        return redirect('apice:mercadolibre:status')
    ...
    return render(request, 'apice/integrations/mercadolibre_products.html', context)
...
def products_sync(request):
    ...
    if request.method != 'POST':
        return redirect('apice:mercadolibre:products_list')
    ...
    if request.method == 'POST':
        ...
        if new_price:
            try:
                ...
                return render(request, 'apice/integrations/mercadolibre_product_edit.html', {
                    'product': product,
                })
...
def questions_inbox(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_questions_inbox.html', context)
...
def questions_inbox_list(request):
    ...
    return render(request, 'apice/integrations/_questions_list.html', context)
...
def question_detail(request, question_id):
    ...
    return render(request, 'apice/integrations/_question_detail.html', context)
...
def question_reply(request, question_id):
    ...
    if not reply_text:
        return render(request, 'apice/integrations/_question_detail.html', {
            'question': question,
...
def question_ignore(request, question_id):
    ...
    if request.htmx:
        ...
        return render(request, 'apice/integrations/_questions_list.html', {
            'questions': qs,
            'current_filter': status_filter,
        })

    return redirect('apice:mercadolibre:questions_inbox')
...
def messages_inbox(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_messages_inbox.html', context)
...
def messages_inbox_list(request):
    ...
    if not integration:
        return render(request, 'apice/integrations/_conversations_list.html', {
            'conversations': [],
        })
    ...
    return render(request, 'apice/integrations/_conversations_list.html', context)
...
def conversation_detail(request, pack_id):
    ...
    if not integration:
        return render(request, 'apice/integrations/_conversation_detail.html', {
    ...
    return render(request, 'apice/integrations/_conversation_detail.html', context)
...
def order_detail(request, order_id):
    ...
    return render(request, 'apice/integrations/mercadolibre_order_detail.html', context)
...
def orders_list(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_orders_list.html', context)
...
def buyer_profile(request, buyer_id):
    ...
    if not orders.exists():
        ...
        if not question:
            ...
            return redirect('apice:mercadolibre:orders_list')
    ...
    return render(request, 'apice/integrations/mercadolibre_buyer_profile.html', context)
...
def metrics_dashboard(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_metrics_dashboard.html', context)
...
def ads_list(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_ads_list.html', context)
...
def ad_campaign_toggle(request, campaign_id):
    ...
    """
    if request.method != 'POST':
        return redirect('apice:mercadolibre:ads_list')
...
def promotions_list(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_promotions.html', context)
...
def promotion_create(request, item_id):
    ...
    if request.method != 'POST':
        return redirect('apice:mercadolibre:promotions_list')
...
def categories_index(request):
    ...
    return render(request, 'apice/integrations/mercadolibre_categories.html', context)
...
def item_create(request):
    ...
    if request.method == 'POST':
        ...
        if errors:
            ...
            return render(request, 'apice/integrations/mercadolibre_item_create.html', {
