    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                ...
                to='apice.mercadolibreintegration',
            ),
        ),
        migrations.AlterField(
            model_name='mercadolibrewebhookevent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('integration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='apice.mercadolibreintegration')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(blank=True, help_text='Contacto CRM creado a partir del comprador', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ml_orders', to='apice.contact')),
                ('deal', models.ForeignKey(blank=True, help_text='Deal CRM creado a partir de la orden', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ml_orders', to='apice.deal')),
                ('integration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='apice.mercadolibreintegration')),
                ('lead', models.ForeignKey(blank=True, help_text='Lead CRM creado a partir de la orden', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ml_orders', to='apice.lead')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency_id', models.CharField(default='ARS', max_length=10)),
                ('category_id', models.CharField(blank=True, default='', max_length=50)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='apice.mercadolibreorder')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_items', to='apice.mercadolibreproduct')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ml_messages', to='apice.contact')),
                ('integration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='apice.mercadolibreintegration')),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='messages', to='apice.mercadolibreorder')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('integration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='apice.mercadolibreintegration')),
                ('lead', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ml_questions', to='apice.lead')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questions', to='apice.mercadolibreproduct')),
            ],
            options={
