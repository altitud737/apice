...
def integrations(request):
    ...
    ml_url = 'apice:mercadolibre:status' if ml_integration else 'apice:mercadolibre:connect'
    ...
    wa_url = 'apice:whatsapp:settings'
    ...
    integrations_status = [
        {
            ...
            'url': 'apice:integrations_web_forms'
        },
        {
            'name': 'MercadoLibre',
            'icon': '�️',
    ...
    return render(request, 'apice/integrations.html', context)
...
<body>
    ...
    return render(request, 'apice/integrations_web_forms.html', context)
