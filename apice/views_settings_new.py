...
def settings_index(request):
    ...
    return render(request, 'apice/settings/index.html', context)
...
def settings_company(request):
    ...
    return render(request, 'apice/settings/company.html', context)
...
def settings_users(request):
    ...
    if not (request.user.is_company_admin or request.user.can_manage_users):
        ...
        return redirect('apice:settings')
    ...
    return render(request, 'apice/settings/users.html', context)
...
def settings_user_create(request):
    ...
    if not (request.user.is_company_admin or request.user.can_manage_users):
        ...
        return redirect('apice:settings_users')
    ...
    if request.method == 'POST':
        try:
            ...
            if User.objects.filter(email=email).exists():
                ...
                return redirect('apice:settings_user_create')
    ...
    return render(request, 'apice/settings/user_create.html', context)
...
def settings_user_edit(request, user_id):
    ...
    return render(request, 'apice/settings/user_edit.html', context)
...
def settings_security(request):
    ...
    if request.method == 'POST':
        ...
        if action == 'change_password':
            ...
            if not request.user.check_password(current_password):
                ...
                return redirect('apice:settings_security')
    ...
    return render(request, 'apice/settings/security.html', context)
...
def settings_support(request):
    ...
    return render(request, 'apice/settings/support.html', context)
...
def settings_support_create(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('apice:settings_support')
    
    context = {
        'company': company,
        'categories': SupportTicket.CATEGORY_CHOICES,
    }
    return render(request, 'apice/settings/support_create.html', context)
...
def settings_support_view(request, ticket_id):
    ...
    return render(request, 'apice/settings/support_view.html', context)
