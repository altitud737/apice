...
Este sistema permite capturar leads desde formularios web externos y registrarlos automáticamente en el ERP. Cada empresa cliente tiene su propia API Key para autenticación.
...
const API_URL = 'https://tuempresa.com/api/leads/';
...
3. **Usuario completa formulario**
   - Datos se envían al ERP vía POST
...
- [ ] Crear vista en el ERP para gestionar leads
...
- `crm/models.py` - Modelo Lead
- `crm/serializers.py` - Serializer para Lead
- `crm/api_views.py` - Vista API para crear leads
- `crm/urls.py` - URL del endpoint
- `crm/admin.py` - Registro de Lead en admin
