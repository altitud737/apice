# Sistema de Super Administrador - ERP ERP

## 📋 Resumen

Sistema completo de super administrador para gestionar clientes del ERP ERP. El registro público está deshabilitado y solo el super admin puede crear nuevos clientes.
...
### ERP (Usuarios Normales)
```
/                         - Dashboard del ERP
/crm/leads/              - Gestión de leads
/crm/contacts/           - Gestión de contactos
/crm/pipeline/           - Pipeline de ventas
/crm/mail/               - Email integrado
/crm/integrations/       - Integraciones
