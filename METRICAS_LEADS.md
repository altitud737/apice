...
def leads_dashboard(request):
    ...
    return render(request, 'apice/leads_dashboard.html', context)
```
...
def send_monthly_report(company):
    ...
    send_mail(
        ...
        from_email='noreply@tuapice.com',
...
Con `source` y `metadata` implementados, tu Apice puede:
...
Esto convierte tu Apice en una herramienta de **marketing intelligence** profesional. 🚀
