# crm/migrations/0009_questions_inbox_module.py
"""
...
def migrate_template_defaults(apps, schema_editor):
    ...
    """
    MercadoLibreReplyTemplate = apps.get_model('crm', 'MercadoLibreReplyTemplate')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('crm', '0008_product_fields_update'),
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                ...
                to='crm.mercadolibrereplytemplate',
            ),
        ),
