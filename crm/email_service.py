...
class EmailService:
    ...
    def send_welcome_email(user):
        ...
        try:
            ...
            Puedes comenzar a usar ERP ahora mismo.
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <p>Tu cuenta ha sido creada exitosamente en nuestro ERP.</p>
                    ...
                    <p>Puedes comenzar a usar ERP ahora mismo.</p>
                    <p style="margin-top: 30px;">Saludos,<br>El equipo de ERP</p>
                </div>
            </body>
            </html>
            """
    ...
    def send_lead_notification(lead, user):
        ...
        try:
            ...
            Se ha creado un nuevo lead en tu crm:
