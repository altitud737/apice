"""
Vistas para gestión de email en ERP
"""
...
def mail_connect(request):
    ...
    try:
        ...
        return redirect('crm:mail_settings')
    
    # Generar URL de autorización
    service = ZohoMailService(integration)
    redirect_uri = request.build_absolute_uri(reverse('crm:mail_callback'))
...
def mail_callback(request):
    ...
    try:
        ...
        return redirect('crm:mail_inbox')
...
def mail_inbox(request):
    ...
    if not integration.is_active:
        ...
        return redirect('crm:mail_connect')
    ...
    try:
        ...
        return render(request, 'crm/mail_inbox.html', context)
...
def mail_view(request, message_id):
    ...
    try:
        ...
        if message:
            ...
            return render(request, 'crm/mail_view.html', context)
        else:
...
def mail_compose(request):
    ...
    return render(request, 'crm/mail_compose.html', context)
