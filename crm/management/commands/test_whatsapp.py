...
from crm.whatsapp_service import get_whatsapp_service
from crm.whatsapp_models import WhatsAppIntegration, WhatsAppMessage
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--message',
            type=str,
            default='Mensaje de prueba desde ERP CRM',
